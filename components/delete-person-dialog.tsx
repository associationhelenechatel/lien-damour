...
export function DeletePersonDialog({ open, onOpenChange, person, onDeletePerson }: DeletePersonDialogProps) {
  const handleDelete = () => {
      ...
      <DialogContent className="sm:max-w-[400px]">
        ...
        <div className="py-4">
          <div className="bg-red-50 border border-red-200 rounded-lg p-4">
            <h4 className="font-medium text-red-800 mb-2">Informations à supprimer :</h4>
